...
## --------------------------------------------------------------------------------
## Script to produce the seasonal/annual Geowind percentiles
##
## Written by Richard Cornes (ricorne@noc.ac.uk), National Oceanography Centre.
## On 2023-07-04
##
## Prerequisite: make_geowind.R
## --------------------------------------------------------------------------------
...
## Write to file
write.csv(geowind.seas,"data/geowind_seasonal_percentiles.csv",row.names=FALSE,quote=FALSE)
write.csv(seas.freqs,"data/geowind_seasonal_frequency.csv",row.names=FALSE,quote=FALSE)
...
## Write to file
write.csv(geowind.ann,"data/geowind_annual_percentiles.csv",row.names=FALSE,quote=FALSE)
write.csv(ann.freqs,"data/geowind_annual_frequency.csv",row.names=FALSE,quote=FALSE)
